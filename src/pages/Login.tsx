...
export default function Login() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        setError(data.error ?? (mode === "login" ? "Invalid email or password" : "Sign-up failed"));
      } else {
        // New signup → onboarding; returning login → dashboard
      ...
      <div className="login-right">
        <div className="login-form-wrap">
          ...
          <div className="login-mode-toggle">
            ...
            <button
              className={`login-mode-btn ${mode === "signup" ? "login-mode-btn-active" : ""}`}
          ...
          {/* Google */}
          <a href="/api/auth/google" className="login-google-btn">
          ...
          <form onSubmit={handleSubmit} className="login-form-new">
            ...
            <button type="submit" className="login-submit" disabled={loading}>
              {loading
                ? <><span className="login-spin" /> {mode === "login" ? "Signing in…" : "Creating account…"}</>
          ...
          <div className="login-form-footer">
            {mode === "login" ? (
              <p>Don't have an account?{" "}
                <button className="login-switch-btn" onClick={() => switchMode("signup")}>Sign up free</button>
              </p>
            ) : (
